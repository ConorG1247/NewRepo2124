...
import ChannelDisplay from "components/Channels/ChannelDisplay";
...
function CategorySelect() {
  ...
  useEffect(() => {
    ...
    let url: string = `https://api.twitch.tv/helix/streams?first=100&game_id=${
      window.location.href.split("categories/")[1]
    }`;
